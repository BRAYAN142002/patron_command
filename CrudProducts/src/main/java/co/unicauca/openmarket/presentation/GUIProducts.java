...
import co.unicauca.openmarket.presentation.commands.OMDeleteProductCommand;
import co.unicauca.openmarket.presentation.commands.OMEditProductCommand;
        ...
        try{
           String id = txtId.getText().trim();
            ...
            if (Messages.showConfirmDialog("Está seguro que desea eliminar este producto?", "Confirmación") == JOptionPane.YES_NO_OPTION) {
             ...
             Messages.showMessageDialog("Error, Contactese con un administrador", "ERROR!!");
        }
